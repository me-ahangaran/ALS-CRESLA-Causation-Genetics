...
for idx=1:row
    ...
    FrsAbsFilePath = strcat('E:\PHD\Thesis\Implementation\ALS-Matlab\Cresla\CFDMatrix\FrsTotalAbsChanges\',strCause,'-',strEffect,'.csv');
...
fnameMaxProb = strcat('E:\PHD\Thesis\Implementation\ALS-Matlab\Cresla\CFDMatrix\MaxPointsFrsAbsProbDens.csv');
fid_MaxProb = fopen(fnameMaxProb,'w');
dlmwrite(fnameMaxProb,maxProb_Mat);
fclose(fid_MaxProb); 

fnameEntropyAbs = strcat('E:\PHD\Thesis\Implementation\ALS-Matlab\Cresla\CFDMatrix\EntropyFrsAbs.csv');
