...
for idx=1:row
    ...
    FrsAbsFilePath = strcat('E:\PHD\Thesis\Implementation\ALS-Matlab\Cresla\CFDMatrix\FrsTotalRelativeChanges\',strCause,'-',strEffect,'.csv');
...
fnameMaxProb = strcat('E:\PHD\Thesis\Implementation\ALS-Matlab\Cresla\CFDMatrix\MaxPointsFrsRelativeProbDens.csv');
fid_MaxProb = fopen(fnameMaxProb,'w');
dlmwrite(fnameMaxProb,maxProb_Mat);
fclose(fid_MaxProb); 

fnameEntropyAbs = strcat('E:\PHD\Thesis\Implementation\ALS-Matlab\Cresla\CFDMatrix\EntropyFrsRelative.csv');
